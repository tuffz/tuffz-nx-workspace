...
describe('SharedUiSocialMediaIcons - Product Hunt', () => {
  it('should renders with "www" Subdomain icon with correct props', () => {
    ...
    expect(anchorElement).toHaveAttribute('title', 'ProductHunt');
    ...
    expect(titleElement).toHaveTextContent('Product Hunt');
  });
