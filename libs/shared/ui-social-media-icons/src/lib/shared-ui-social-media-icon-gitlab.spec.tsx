...
describe('SharedUiSocialMediaIcons - GitLab', () => {
  it('should renders with "www" Subdomain icon with correct props', () => {
    const props = {
      size: 24,
      url: 'https://www.gitlab.com/tuffz',
    };
    ...
    expect(anchorElement).toHaveAttribute('title', 'GitLab');
    ...
    expect(titleElement).toHaveTextContent('GitLab');
  });
