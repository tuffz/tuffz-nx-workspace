...
describe('SharedUiSocialMediaIcons - X (former Twitter)', () => {
  it('should renders with "www" Subdomain icon with correct props', () => {
    const props = {
      size: 24,
      url: 'https://www.x.com/tuffzCOM',
    };
    ...
    expect(anchorElement).toHaveAttribute('title', 'X');
    ...
    expect(titleElement).toHaveTextContent('X (former Twitter)');
  });

  it('should renders WITHOUT "www" Subdomain icon with correct props', () => {
    const props = {
      size: 24,
      url: 'https://x.com/tuffzCOM',
    };
...
describe('SharedUiSocialMediaIcons - Twitter', () => {
  it('should renders with "www" Subdomain icon with correct props', () => {
    const props = {
      size: 24,
      url: 'https://www.twitter.com/tuffzCOM',
    };
